...
class myplot_1d {
    ...
    */
    ...
    apply_phase_correction() {
        ...
        if (spectrum_index === -1 || this.spectrum_dimension[spectrum_index] != 3) {
            throw new Error('myplot_1d function apply_phase_correction cannot apply phase correction because no spectrum is selected');
        }
    ...
    */
        ...
        if (this.$peaks_symbol) {
            switch (flag) {
                ...
                case 4:
                    ...
                    break;
                default:
                    console.warn("myplot_1d: redraw_peaks called with unknown flag: " + flag);
                    break;
            }
        }
    }
    ...
    /**
     * Apply reference correction to the spectrum with designated spectrum_index and value
